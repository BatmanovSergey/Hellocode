...
Method2("Текст сообщения - Method2"); // Вызов void метода2, в качестве аргумента передаем "Текст сообщния" в кавычках
...
// строку string c будем дург за дружкой компановать count раз
